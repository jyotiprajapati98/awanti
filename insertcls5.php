...
mysql_query("insert into class5(stdcode,name,fname,mname,rlg,cate,dob,bloodgrp,class,address,adsdate,fee,pay,ref,contact,img) values('$cod','$name','$father','$mother','$reli','$cat','$d','$bld','$cl','$ad','$d','$tf','$pa','$re','$nu','$pname')",$connect);
