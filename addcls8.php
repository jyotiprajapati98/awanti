...
<center><h1><font color="#FF0000"><i><u>Addmission in class 8</u></i></font></h1></center>
<center>
<div id="form">
<form action="insertcls8.php" method="post" enctype="multipart/form-data" onSubmit="return validationForm()" name="rf">
Std Code
