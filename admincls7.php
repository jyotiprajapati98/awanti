...
<div id="table">
<center><table border="1"><center><table border="1"bgcolor="#FFFFCC" cellspacing="5" cellpadding="5" >
<tr>
...
$q=mysql_query("select * from class7",$con) or die("Query Error");
$count=0;
while($row=mysql_fetch_array($q))
{
	...
	<td><a href='editcls7.php?id=$id'>Edit</a></td>
	<th><a href='delcls7.php?id=$id'>Delete</a></th>
