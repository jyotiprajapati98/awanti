...
<div id="table">
<center><table border="1"bgcolor="#FFFFCC" cellspacing="3" cellpadding="5" >
<tr>
...
<th><font color="#FF0000">Bloodgrp</th>
...
$q=mysql_query("select * from class3",$con) or die("Query Error");
$count=0;
while($row=mysql_fetch_array($q))
{
	...
	<td><a href='editcls3.php?id=$id'>Edit</a></td>
	<th><a href='delcls3.php?id=$id'>Delete</a></th>
