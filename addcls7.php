...
<center><h2><font color="#FF0000"><i><u>Addmission in class 7</u></i></font></h2></center>
<center>
<div id="form">
<form action="insertcls7.php" method="post" enctype="multipart/form-data" onSubmit="return validationForm()" name="rf">
Std Code
