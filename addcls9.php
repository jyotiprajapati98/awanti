...
<center><h1><font color="#FF0000"><i><u>Addmission in class 9</u></i></font></h1></center>
<center>
<div id="form">
<form action="insertcls9.php" method="post" enctype="multipart/form-data" onSubmit="return validationForm()" name="rf">
Std Code
