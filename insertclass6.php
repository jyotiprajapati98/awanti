...
mysql_query("insert into class6(stdcode,name,fname,mname,rlg,cate,dob,bloodgrp,class,address,adsdate,fee,pay,ref,contact,img) values('$sid','$name','$father','$mother','$reli','$cat','$d','$bld','$cl','$ad','$d','$tf','$pa','$re','$nu','$pname')",$connect);
