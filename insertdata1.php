...
mysql_query("insert into kg1(stdcode,name,fname,mname,rlg,cate,dob,bloodgrp,class,address,adsdate,fee,pay,ref,contact,pic) values('$sid','$name','$father','$mother','$reli','$cat','$d','$bld','$cl','$ad','$d','$tf','$pa','$re','$nu','$pname')",$connect);
